...
trait DonationAttribute
{
    ...
    {
        return '<a href="' .
            route('admin.donation.show', $this) .
    ...
    {
        return '<a href="' .
            route('admin.donation.edit', $this) .
            '" data-toggle="tooltip" data-placement="top" title="' .
    ...
    {
        return '<a href="' .
            route('admin.donation.destroy', $this) .
            '"
			 data-method="delete"
    ...
    {
        return '<div
       class="btn-group btn-group-sm" donation="group" aria-label="Donation Actions">
	   		 ' .
            $this->view_button .
            '
			  ' .
