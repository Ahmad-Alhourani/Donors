...
trait FundraisingAttribute
{
    ...
    {
        return '<a href="' .
            route('admin.fundraising.show', $this) .
    ...
    /**
     * @return string  fundraising
     */
    public function getEditButtonAttribute()
    {
        return '<a href="' .
            route('admin.fundraising.edit', $this) .
            '" data-toggle="tooltip" data-placement="top" title="' .
    ...
    {
        return '<a href="' .
            route('admin.fundraising.destroy', $this) .
            '"
			 data-method="delete"
    ...
    {
        return '<a href="' .
            route('admin.donor.fundraising', $this) .
            ' " class="dropdown-item">' .
            __('Donors') .
            '</a> ';
    }
    ...
    {
        return '<div
       class="btn-group btn-group-sm" fundraising="group" aria-label="Fundraising Actions">
	   		 ' .
            $this->view_button .
            '
			  ' .
