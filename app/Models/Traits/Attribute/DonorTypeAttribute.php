...
trait DonorTypeAttribute
{
    ...
    {
        return '<a href="' .
            route('admin.donor_type.show', $this) .
    ...
    /**
     * @return string  donor_type
     */
    public function getEditButtonAttribute()
    {
        return '<a href="' .
            route('admin.donor_type.edit', $this) .
            '" data-toggle="tooltip" data-placement="top" title="' .
    ...
    {
        return '<a href="' .
            route('admin.donor_type.destroy', $this) .
            '"
			 data-method="delete"
    ...
    {
        return '<a href="' .
            route('admin.donor.donor_type', $this) .
            ' " class="dropdown-item">' .
            __('Donors') .
            '</a> ';
    }
    ...
    {
        return '<div
       class="btn-group btn-group-sm" donor_type="group" aria-label="DonorType Actions">
	   		 ' .
            $this->view_button .
            '
			  ' .
