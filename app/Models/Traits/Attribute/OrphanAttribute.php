...
trait OrphanAttribute
{
    ...
    {
        return '<a href="' .
            route('admin.orphan.destroy', $this) .
            '"
			 data-method="delete"
    ...
    {
        return '<div
       class="btn-group btn-group-sm" orphan="group" aria-label="Orphan Actions">
	   		 ' .
            $this->view_button .
            '
			  ' .
