...
trait CountryAttribute
{
    ...
    {
        return '<a href="' .
            route('admin.country.destroy', $this) .
            '"
			 data-method="delete"
     ...
     * @return  string
     */
    public function getCitysButtonAttribute()
    {
        return '<a href="' .
            route('admin.city.country', $this) .
            ' " class="dropdown-item">' .
            __('Citys') .
            '</a> ';
    }
    ...
    {
        return '<div
       class="btn-group btn-group-sm" country="group" aria-label="Country Actions">
	   		 ' .
            $this->view_button .
            '
			  ' .
